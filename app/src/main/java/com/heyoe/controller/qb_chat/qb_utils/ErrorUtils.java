package com.heyoe.controller.qb_chat.qb_utils;
...
public class ErrorUtils {
    ...
    public static void showErrorToast(QBResponseException exception) {
        Utils.showToast(App.getInstance(), String.format("[ERROR] Request has been completed with errors: %s", exception.getErrors()
