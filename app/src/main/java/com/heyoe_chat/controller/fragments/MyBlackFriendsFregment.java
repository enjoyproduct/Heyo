 ...
 *
 */
public class MyBlackFriendsFregment extends Fragment {
...
//                    arrActiveUsers.addAll(temp);
    ...
    private void initUI(View view) {
        ...
        btnFriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btnBlocked.setBackgroundColor(mActivity.getResources().getColor(R.color.dark));
        ...
        btnBlocked.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btnFriend.setBackgroundColor(mActivity.getResources().getColor(R.color.dark));
    ...
    private void getBlackFriends() {
        ...
        CustomRequest signinRequest = new CustomRequest(Request.Method.POST, API.GET_BLACK_FRIENDS, params,
...
//                                Utils.showOKDialog(mActivity, getResources().getString(R.string.incorrect_password));
    ...
    private void removeFromBlackList(final int position) {
        ...
        CustomRequest signinRequest = new CustomRequest(Request.Method.POST, API.REMOVE_FROM_BLACK_LIST, params,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        Utils.hideProgress();
