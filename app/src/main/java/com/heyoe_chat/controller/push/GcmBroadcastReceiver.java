...
public class GcmBroadcastReceiver extends WakefulBroadcastReceiver {
    ...
    public final static String LAYER_CONVERSATION_KEY = "conversation_identifier";
    public final static String LAYER_MESSAGE_KEY = "message_identifier";
    @Override
...
//
//        String[] str1 = extras.getString("layer").split(",");
//
...
//
//        final Uri conversationId = Uri.parse(c_id);
//        final Uri messageId = Uri.parse(m_id);
