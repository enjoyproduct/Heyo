 ...
 *
 * @see com.heyoe_chat.controller.App.Flavor
 * @see com.heyoe_chat.controller.layer_chat.Flavor
 * @see LayerClient
...
public class App extends Application {
    ...
    private static Flavor sFlavor = new com.heyoe_chat.controller.layer_chat.Flavor();
    ...
    public void onCreate() {
        ...
        if (BuildConfig.DEBUG) {
            ...
            com.heyoe_chat.controller.layer_chat.util.Log.setAlwaysLoggable(true);
    ...
    public static LayerClient getLayerClient() {
        if (sLayerClient == null) {
            ...
            options.googleCloudMessagingSenderId(getInstance().getResources().getString(R.string.project_id));
